...
- **Vakuum/Luft**: $c≈3×10^8 \text{m/s}$ (Lichtgeschwindigkeit)
- **Kupferkabel**: $v≈ 0,6 × c ≈ 1,8×10^8\text{m/s}$
- **Glasfaser**: $v ≈ 0,67 × c ≈ 2×10^8\text{m/s}$
$$
Latenz = UEV + AV
$$
...
$$
- $c \approx 3 * 10^8[m\text{/s}]$ im Vacuum.
