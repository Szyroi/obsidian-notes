...
> [!definition] [[Reflexivität#Eigenschaften von Relationen | Reflexivität]]  
> 
...
> 
> Auf \(\mathbb{N}\): \(a \mid b\) (a teilt b) ist reflexiv und transitiv, aber nicht symmetrisch; auf \(\mathbb{N}\setminus\{0\}\) ist sie antisymmetrisch (wenn man passende Konventionen annimmt).
