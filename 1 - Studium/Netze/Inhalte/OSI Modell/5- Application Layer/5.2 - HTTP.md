...
- Eine Vielzahl von Szenarien benötigt jedoch „Sessions“ (z. B. Online-Banking, Webshops). Zu diesem Zweck wurden Cookies [2] eingeführt. Idee: Server gibt dem Client einen Cookie. - Client-Requests enthalten diesen Cookie. - Server kann die Sitzung bzw. den Client identifizieren.