...
- TLD-Zonen signieren darunterliegende Domains Wichtige zusätzliche RR-Typen: DNSKEY: öffentlicher Schlüssel der Zone DS: Delegation Signer (Verweis auf Schlüssel der Child-Zone) RRSIG: Signatur eines RR-Sets NSEC/NSEC3: kryptografischer Beweis für Nicht-Existenz eines Namens Schützt die Integrität und Authentizität von DNS-Daten, aber nicht deren Vertraulichkeit.