...
- Der Eintrag liegt *nicht* im Cache. Der rekursive Resolver startet deshalb eine iterative Auflösung beginnend bei einem Root-Nameserver. 3. Der Root-Server liefert einen Verweis (NS + Glue) auf die Nameserver der org-TLD. 4. Der rekursive Resolver fragt einen org-TLD-Nameserver nach en.wikipedia.org.. 5. Der TLD-Server verweist auf die autoritativen Nameserver der Zone wikipedia.org. 6. Der rekursive Resolver fragt einen dieser autoritativen Nameserver nach en.wikipedia.org.. 7. Der autoritative Nameserver wikipedia.org liefert die IP-Adresse von en.wikipedia.org.. 8. Der rekursive Resolver speichert die Antwort im Cache und sendet sie an den Client zurück.
