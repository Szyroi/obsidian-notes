...
- Router signalisieren Überlastsituationen an Empfänger, welcher die Information an den Sender kommuniziert. - Anpassung bzw. Nutzung von IP/TCP-Headerfeldern Beispiel: TCP ECN (Explicit Congestion Notification), RFC 3168 [6] und RFC 8311 [3]
