#netze/vorlesung 
# 07.05.2024
[[Netze Vorlesung 05.pdf]]
## 05
#### IPv6
(Neuere) Alternative zu IPv4
128 bit Addressen (vs 32 bit)

Addressen als 8 blöcke von je 4 hex-chars.
Leading 0s pro block trimmed
Eine (die längste) folge an 0-blöcken wird weggelassen, als `::` geschrieben
...
![[Netze IPv6 Addresse aus MAC.png]]
