...
## **Congestion Control**
### **Problem**
- Viele Sender überlasten das Netzwerk
- Folgen: Lange Warteschlangen, Paketverluste, erhöhter Verkehr durch Retransmissions
### **Ansätze**
1. **Netzgestützt** (z.B. **ECN** - Explicit Congestion Notification)
...
### **TCP-Algorithmen**
- **TCP Tahoe**: Bei Verlust → cwnd = 1 MSS (konservativ)
- **TCP Reno**: **Fast Recovery** bei 3 Dup-ACKs (cwnd/2)
- **TCP Cubic**: Standard in Linux (für High-BDP-Netze)
- **TCP Westwood:** Forschungsalgorithmus, nie als RFC standardisiert
- **TCP Cubic:** RFC 8312 (Standard in Linux; gut für High-BDP-Netze)
### **Initial Window (IW)**
